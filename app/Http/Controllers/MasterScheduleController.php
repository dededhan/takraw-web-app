...
class MasterScheduleController extends Controller
{
    ...
    public function saveConfig(Request $request, Tournament $tournament)
    {
        ...
        $validated = $request->validate([
            ...
            'day_overrides.*.sessions_before_break'    => 'nullable|integer|min:1|max:20',
            'day_overrides.*.ishoma_duration_minutes'  => 'nullable|integer|min:0|max:240',
            'day_overrides.*.sessions_after_break'     => 'nullable|integer|min:0|max:20',
            'day_overrides.*.has_extra_breaks'         => 'nullable|boolean',
