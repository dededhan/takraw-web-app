                        ...
                        <nav className="flex items-center gap-4">
                            {auth.user ? (
                                <Link
                                    ...
                                    className="px-5 py-2.5 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-500 transition duration-300 shadow-md shadow-indigo-600/20 text-sm"
                                >
                                    Dashboard
                                </Link>
                            ) : (
                    ...
                    <div className="relative rounded-3xl border border-slate-800/80 bg-gradient-to-tr from-slate-950 via-slate-900 to-indigo-950/80 p-8 sm:p-16 text-center overflow-hidden shadow-2xl">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
                            {auth.user ? (
                                <Link
                                    href={route('dashboard')}
                                    className="px-8 py-4 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-500 transition duration-300 shadow-xl shadow-indigo-600/30 text-sm"
                                >
                                    Masuk ke Dashboard
                                </Link>
                            ) : (
