        ...
        <AuthenticatedLayout header="Daftarkan Tim">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="rounded-xl border border-surface-700/50 bg-surface-900/50 backdrop-blur-sm p-6">
                    <h2 className="text-xl font-bold text-surface-100 mb-6">👥 Daftarkan Tim Baru</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Elang Jakarta"
                                />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            {/* Tournament */}
                            <div>
                                <label className="block text-sm font-medium text-surface-300 mb-2">Daftarkan ke Turnamen</label>
                                <select
                                    value={data.tournament_id}
                                    onChange={(e) => setData('tournament_id', e.target.value)}
                                    className="w-full px-4 py-3 rounded-xl bg-surface-800 border border-surface-700 text-surface-100 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors"
                                >
                                    <option value="">— Pilih Turnamen (Opsional) —</option>
                                    {tournaments?.map((t) => (
                        ...
                        <div>
                            ...
                            {Object.keys(errors).filter(k => k.startsWith('athletes.')).map(k => (
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-surface-700/50">
                            ...
                            >
                                {processing ? 'Menyimpan...' : '✨ Daftarkan Tim'}
                            </button>
                        </div>
                    </form>
                </div>
